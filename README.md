...
6. If the connection is right, you should see a message similar to this : ![alt text](src/elastic_login.png)
...
![alt text](src/docker-desktop.png)
2. Execute 
